        ...
        <div class="container"> 
            <div class="row">
                ...
                <div class="col-md-6" style="text-align:right">
                    <br />
                    <asp:HyperLink ID="hlAddContactCategory" runat="server" NavigateUrl="~/AdminPanel/ContactCategory/ContactCategoryAddEdit.aspx" CssClass="btn btn-success">Add ContactCategory</asp:HyperLink>
                </div>
            </div>
            <br />
            <div class="row">
                    ...
                    <asp:GridView ID="gvContactCategory" runat="server" CssClass="table table-hover" OnRowCommand="gvContactCategory_RowCommand" AutoGenerateColumns="false" >
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Edit Record">
                                <ItemTemplate>
                                    <asp:HyperLink ID="hlEdit" runat="server" NavigateUrl='<%# "~/AdminPanel/ContactCategory/ContactCategoryAddEdit.aspx?ContactCategoryID=" + Eval("ContactCategoryID").ToString().Trim() %>'  CssClass="btn btn-warning">Edit</asp:HyperLink> 
                                </ItemTemplate>
                            </asp:TemplateField>
