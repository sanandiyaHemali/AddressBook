...
public partial class AddressBook_AdminPanel_ContactCategory_ContactCategoryAddEdit : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            {
                lblHeader.Text = "Edit ContactCategory | ContactCategoryID = " + Request.QueryString["ContactCategoryID"].ToString();
                FillControls(Convert.ToInt32(Request.QueryString["ContactCategoryID"].ToString()));
            }
            else
            {
