        ...
        <div class="container"> 
            <div class="row">
                ...
                <div class="col-md-6" style="text-align:right">
                    <br />
                    <asp:HyperLink ID="hlAddState" runat="server" NavigateUrl="~/AdminPanel/State/StateAddEdit.aspx" CssClass="btn btn-success">Add State</asp:HyperLink>
                </div>
            </div>
            <br />
            <div class="row">
                    ...
                    <asp:GridView ID="gvState" runat="server" CssClass="table table-hover" OnRowCommand="gvState_RowCommand" AutoGenerateColumns="false" >
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Edit Record">
                                <ItemTemplate>
                                    <asp:HyperLink ID="hlEdit" runat="server" NavigateUrl='<%# "~/AdminPanel/State/StateAddEdit.aspx?StateID=" + Eval("StateID").ToString().Trim() %>'  CssClass="btn btn-warning">Edit</asp:HyperLink> 
                                </ItemTemplate>
                            </asp:TemplateField>
