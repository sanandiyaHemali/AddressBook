        ...
        <div class="container"> 
            <div class="row">
                ...
                <div class="col-md-6" style="text-align:right">
                    <br />
                    <asp:HyperLink ID="hlAddCity" runat="server" NavigateUrl="~/AdminPanel/City/CityAddEdit.aspx" CssClass="btn btn-success">Add City</asp:HyperLink>
                </div>
            </div>
            <br />
            <div class="row">
                    ...
                    <asp:GridView ID="gvCity" runat="server" CssClass="table table-hover" OnRowCommand="gvCity_RowCommand" AutoGenerateColumns="false" >
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Edit Record">
                                <ItemTemplate>
                                    <asp:HyperLink ID="hlEdit" runat="server" NavigateUrl='<%# "~/AdminPanel/City/CityAddEdit.aspx?CityID=" + Eval("CityID").ToString().Trim() %>'  CssClass="btn btn-warning">Edit</asp:HyperLink> 
                                </ItemTemplate>
                            </asp:TemplateField>
