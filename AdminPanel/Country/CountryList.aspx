        ...
        <div class="container"> 
            <div class="row">
                ...
                <div class="col-md-6" style="text-align:right">
                    <br />
                    <asp:HyperLink ID="hlAddCountry" runat="server" NavigateUrl="~/AdminPanel/Country/CountryAddEdit.aspx" CssClass="btn btn-success">Add Country</asp:HyperLink>
                </div>
            </div>
            <br />
            <div class="row">
                    ...
                    <asp:GridView ID="gvCountry" runat="server" CssClass="table table-hover" OnRowCommand="gvCountry_RowCommand" AutoGenerateColumns="false" >
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Edit Record">
                                <ItemTemplate>
                                    <asp:HyperLink ID="hlEdit" runat="server" NavigateUrl='<%# "~/AdminPanel/Country/CountryAddEdit.aspx?CountryID=" + Eval("CountryID").ToString().Trim() %>'  CssClass="btn btn-warning">Edit</asp:HyperLink> 
                                </ItemTemplate>
                            </asp:TemplateField>
